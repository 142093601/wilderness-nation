...
**目标环境：Minecraft 1.21.1 + NeoForge（Java 21）** · 3~7 人私人服务器 · 约 300 小时毕业（7~14 个月）
...
> 来源：`DESIGN.md` §17（六个时代的玩法规格，按 **300 小时**口径：24 / 40 / 50 / 50 / 60 / 76）。
...
`DESIGN.md` §15 已按 300 小时重算：**任务 27 → ~90~110**；**内容 mod 总量 80~120 现在正当**。
