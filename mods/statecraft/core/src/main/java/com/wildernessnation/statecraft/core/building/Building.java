 ...
 * @param materializedAtSeq   §五：上次实体化序号（0 = 从未）
...
public record Building(
    ...
    public Building {
        ...
        if (materializedAtSeq < 0) {
            throw new IllegalArgumentException(
                    "Building.materializedAtSeq 不能为负：" + materializedAtSeq);
        }
    ...
    public static Building register(String id, String type, Anchor anchor) {
        return new Building(id, type, anchor, 1, null, 0L, 0.0, 0L);
    }
